...
class InstallSheets
{
    ...
    public $slugPlural = 'sheets';

    public $tables = ['sheets'];

    public $resources = ['SheetResource'];
    ...
    protected function install(bool $force = false)
    {
        ...
        $this->addToRoutes([
            "Route::name('sheets.show')->get('/{type}s/{page:slug}/', [\\App\\Http\\Controllers\\SheetsController::class, 'show']);",
        ], true);
